...
def oneplayer():
    ...
    def Pjuego():
        ...
        while fold== True:
            ...
            elif  pos2 == posV or Q4 == posV or Q7 == posV:
                x=random.randrange(0,40)
                if x % 2 == 0:
        ...
        while fold== True:
            ...
            if pos[1] >700:
                ...
                if mapas == 1:
                    ...
                    carroRojo= canvas.create_image(0,10, image=imagen2)
                    canvas.move(carroRojo,0,0)
                    carroAzul= canvas.create_image(0,0, image=imagen3)
                    carroA= canvas.create_image(0,0, image=imagen5)
    ...
    Level2=Button(ventana1,text="Normal",width=10,height=1,command=P2juego,activebackground="green",bg="black",font=("Virtual DJ",12),fg="white").place(x=280,y=370)
    Level3=Button(ventana1,text="Hard",width=10,height=1,command=P3juego,activebackground="pink",bg="black",font=("Virtual DJ",12),fg="white").place(x=280,y=400)
    Level4=Button(ventana1,text="Extreme",width=10,height=1,command=P4juego,activebackground="red",bg="black",font=("Virtual DJ",12),fg="white").place(x=280,y=430)
    Level5=Button(ventana1,text="Impossible",width=10,height=1,command=P5juego,activebackground="red",bg="black",font=("Virtual DJ",12),fg="white").place(x=280,y=460)
    ventana.iconify()
